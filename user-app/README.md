...
- **Боевые формирования** - создание и управление военными формированиями (лэнсы, роты, дивизии)
...
│   ├── FormationModal.tsx # Модальное окно боевых формирований
...
│   ├── FormationsPage.tsx # Страница боевых формирований
...
#### FormationModal.tsx
- Создание и редактирование боевых формирований
- Выбор типа формирования: Лэнс (4 юнита), Рота (12 юнитов), Дивизия (40 юнитов)
- Выбор фракции и назначение пилотов
- Валидация правил формирования
...
#### Управление
- **FormationsPage** - управление боевыми формированиями
...
### Система боевых формирований

#### Создание формирований
- Выбор типа формирования: Лэнс, Рота, Дивизия
- Выбор фракции из доступных в кампании
- Назначение пилотов с соответствующими ролями
- Валидация правил формирования
- Сохранение и редактирование

#### Типы формирований
- **Лэнс (LANCE)** - базовая тактическая единица из 4 юнитов
- **Рота (COMPANY)** - состоит из 3-4 лэнсов (12 юнитов)
- **Дивизия (DIVISION)** - состоит из нескольких рот (40 юнитов)

#### Система ролей
- **LANCE_LEADER** - командир лэнса
- **COMPANY_LEADER** - командир роты
- **DIVISION_COMMANDER** - командир дивизии
- **BODYGUARD** - телохранитель (для командных лэнсов)
...
#### Боевые формирования
```typescript
formations.getAll()          // Получить все формирования
formations.getById(id)       // Получить формирование по ID
formations.getByCampaign(id) // Получить формирования кампании
formations.create(data)      // Создать формирование
formations.update(id, data)  // Обновить формирование
formations.delete(id)        // Удалить формирование
```
...
#### Типы формирований
- **LANCE** - Лэнс (4 юнита)
- **COMPANY** - Рота (12 юнитов) 
- **DIVISION** - Дивизия (40 юнитов)
